                        ...
                        <div class="checkout-inner">
                            <div class="billing-address">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <label>Address</label>
                                        <input class="form-control" type="text" value="<?php echo $user['address']?>" placeholder="Địa chỉ giao hàng" value="" name="address">
                                    </div>
                                    <div class="col-md-4">
                                        <label>Note</label>
...
<?php }?>
<script src="https://www.paypal.com/sdk/js?client-id=AdDLIeeRQqRzLmP9sMrOBaE9JZM6M1WZUDS58i8D0cOmDwGWtBX7hSNQlpph5B988RhNSb_pZYUOJTFj&disable-funding=credit,card"></script>
