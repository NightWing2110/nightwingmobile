...
<body>
  ...
  <section id="aa-catg-head-banner">
    <img src="templates/nightwingmobile/img/slider/Wristwatch11.jpg" alt="fashion img">
          ...
          <div class="aa-product-catg-content">
            ...
            <div class="aa-product-catg-body">
              <ul class="aa-product-catg">
                <?php
                $queryProduct = "SELECT * FROM product WHERE parent_id=3";
