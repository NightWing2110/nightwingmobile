        ...
        <div class="row">
            ...
            if(isset($_POST['submit'])){
                ...
                $query = "UPDATE `users` SET  `username`='{$username}',
                                              ...
                                              `address`='{$address}',
                                              `fullname`='{$fullname}',
                                              `role`='{$role}' WHERE users_id = $user_id";
                $result = $mysqli->query($query);
                if($result){
                    header("location:index.php?msg=Cập nhật người dùng thành công");
                    die();
                }else{
                    echo "Lỗi khi cập nhật người dùng.Vui lòng thử lại";
                }
            }
            ?>
                    ...
                    <div class="form-group col-sm-8">
                        <label">Username</label>
                            ...
                            <div class="row">
                                ...
                                <input type="text" class="form-control" name="fullname" value="" placeholder="Nhập tên" value="<?php echo $infoUser['fullname']?>">
                                <label">Email</label>
