    ...
    <div class="container-fluid">
        ...
        <div class="row">
            ...
            if(isset($_POST['submit'])){
                ...
                $query = "UPDATE `cat` SET  `name`='{$name}',
                                            `parent_id`='{$parent_id}' WHERE cat_id = $cat_id";
                $result = $mysqli->query($query);
                if($result){
                    header("location:index.php?msg= Cập nhật danh mục thành công");
                }else{
                    echo "Lỗi khi cập nhật danh mục.Vui lòng thử lại";
                }
            }
            ?>
                <form action="" method="POST">
                    ...
                    <div class="form-group col-sm-8">
                        ...
                        <input type="text" class="form-control" value="<?php echo $infoCat['parent_id']?>" name="parent_id" placeholder="Nhập lớp" required>
                    </div>
